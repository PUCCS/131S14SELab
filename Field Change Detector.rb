...
def set_like_scientific()
	...
	@like_scientific_sign.change() do
		##
		#Whenever a change to this edit_line is detected it will run the code in this block
		#The block is passed the variable 'self' which is is the edit_line that was changed
		##
	end
	#line going to sign
	line 23, 35, 23, 65
